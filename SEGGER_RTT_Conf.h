...
#define SEGGER_RTT_MAX_NUM_DOWN_BUFFERS \
    (2)  // Max. number of down-buffers (H->T) available on this target  (Default: 3)

#define BUFFER_SIZE_UP (512)  // Size of the buffer for terminal output of target, up to host (Default: 1k)
#define BUFFER_SIZE_DOWN \
    (256)  // Size of the buffer for terminal input to target from host (Usually keyboard input) (Default: 16)
